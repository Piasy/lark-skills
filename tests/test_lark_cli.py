...
from markdown_larkdoc_sync.lark_cli import LarkCLI, LarkCLIError
...
def test_run_json_wraps_file_not_found_error(monkeypatch):
    ...
    monkeypatch.setattr('markdown_larkdoc_sync.lark_cli.subprocess.run', _raise_file_not_found)
